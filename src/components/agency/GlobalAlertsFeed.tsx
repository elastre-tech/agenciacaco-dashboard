...
interface GlobalAlertsFeedProps {
  alerts: AlertWithWorkspace[]
}
...
export default function GlobalAlertsFeed({ alerts }: GlobalAlertsFeedProps) {
  if (!alerts.length) {
    return (
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="font-body text-[11px] text-primary font-medium mt-1">
